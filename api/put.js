...
exports["default"] = (function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var body, headers, authorization, collectionName, filter, document, databaseConnection, collection, _a, _b, _c, e_1;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                collectionName = body.collectionName, filter = body.filter, document = body.document;
            ...
            case 2:
                ...
                _c = {};
                return [4 /*yield*/, collection.updateOne(filter, { $set: document }, { upsert: true })];
            case 3:
